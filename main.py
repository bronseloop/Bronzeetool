...
def banner(console):
    ...
    console.print("[bold green]ಢ‸ಢ  ZeeTool[/bold green]: Car Parking Multiplayer Hacks")
    console.print(f"[bold green]ಢ‸ಢ  Telegram[/bold green]: [bold blue]@{__CHANNEL_USERNAME__}[/bold blue] or [bold blue]@{__GROUP_USERNAME__}[/bold blue].")
