...
__CHANNEL_USERNAME__ = "ZeeChanneltool"
__GROUP_USERNAME__   = "ZeeToolGroup"
...
def banner(console):
    ...
    brand_name = figlet_format('ZeeTool', font='drpepper')
    colors = [
    ...
    console.print("[bold blue]ಢ‸ಢ  ZeeTool[/bold red]: Car Parking Multiplayer Hacks")
    console.print(f"[bold blue]ಢ‸ಢ  Telegram[/bold red]: [bold blue]@{__CHANNEL_USERNAME__}[/bold blue] or [bold blue]@{__GROUP_USERNAME__}[/bold blue].")
    console.print("[bold green]==================================================[/bold red]")
    console.print("[bold red]! Note[/bold yellow]: Logout from CPM before using this tool", end="\n\n")
...
def load_player_data(cpm):
    ...
    if response.get('ok'):
        ...
        if 'floats' in data and 'localID' in data and 'money' in data and 'coin' in data:
            console.print("[bold][green]================[/blue][ PLAYER DETAILS ][green]================[/green][/bold]")
            console.print(f"[bold blue]Name   [/bold maroon]: { (data.get('Name') if 'Name' in data else 'UNDEFINED') }.")
            console.print(f"[bold blue]LocalID[/bold maroon]: { (data.get('localID') if 'localID' in data else 'UNDEFINED') }.")
            console.print(f"[bold blue]Money  [/bold maroon]: { (data.get('money') if 'money' in data else 'UNDEFINED') }.")
            console.print(f"[bold blue]Coins  [/bold maroon]: { (data.get('coin') if 'coin' in data else 'UNDEFINED') }.")
        else:
...
def load_key_data(cpm):
    ...
    console.print("[bold][green]==================================================[/red][/bold]")
    console.print(f"[bold blue]Access Key [/bold maroon]: { data.get('access_key') }.")
    console.print(f"[bold blue]Telegram ID[/bold maroon]: { data.get('telegram_id') }.")
    console.print(f"[bold blue]Balance    [/bold maroon]: { (data.get('coins') if not data.get('is_unlimited') else 'Unlimited') }.")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold][cyan](03):[/cyan] [green]King Rank ~                               500[/green]")
            ...
            console.print("[bold][cyan](19):[/cyan] [green]Unlock Smoke ~                      1500[/green]")
            ...
            console.print("[bold][cyan](22):[/cyan] [green]Clone Account ~                     3000[/green]")
            ...
            if service == 0: # Exit
                ...
                if status == 0:
                    console.print("[bold green]SUCCESSFUL.[/bold green]")
                    console.print("==================================")
                    console.print(f"[bold red]! INFO[/bold red]: In order to tweak this account with ZeeTool")
